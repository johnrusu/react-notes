...
router[ROUTES.CREATE_NOTE.method.toLowerCase()](
  ...
  async (req, res) => {
    try {
      ...
      if (highlighted !== undefined) noteData.highlighted = highlighted;
      if (height !== undefined) noteData.height = height;
      if (orderId !== undefined) noteData.orderId = orderId;
      if (isHtml !== undefined) noteData.isHtml = isHtml;
      if (collapsed !== undefined) noteData.collapsed = collapsed;
