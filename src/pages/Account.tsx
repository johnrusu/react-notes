...
const Account = (): React.ReactElement => {
  ...
  // Safety check - this should not happen since ProtectedRoute handles authentication
  if (isNilOrEmpty(user) || !user) {
    return (
  ...
  return (
    <Container maxWidth="lg">
      ...
      <Paper elevation={3} sx={{ p: 4, mb: 2 }}>
        <Typography variant="h5" gutterBottom sx={{ mb: 3 }}>
          {ACCOUNT_PAGE.sections.notesSummary}
        </Typography>
        <NotesSummary />
      </Paper>
      ...
      <Paper elevation={3} sx={{ p: 4 }}>
        <Typography variant="h5" gutterBottom sx={{ mb: 3 }}>
          {ACCOUNT_PAGE.sections.appDatabase}
        </Typography>
        <Database />
      </Paper>
    </Container>
